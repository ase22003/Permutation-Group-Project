#
# TODO: REMOVE ALL DUPLICATES FROM GROUP, SUCH AS (12) AND (21) OR (34)(56) AND (65)(34)! THIS CAN PROBABLY BE DONE BY SEARCHING THE STATE-SPACE INSTEAD OF THE CURRENT APPROACH
#
...
function color_graph(edges, edge_gens, colors, generators::SetOfPermutations)
	cds = Dict()
...
colors = color_graph(edges, edge_gens, ["blue","red","green","yellow"],generators)
println(edge_gens)
println(edges)
#=
TikzPictures.save(TikzPictures.PDF("gr"),plot(graph,
Layouts.SimpleNecklace(),
#Layouts.SpringElectrical(),
s, edge_style="thick", edge_styles=colors, node_style="draw, rounded corners, fill=green!10"))
=#
...
println("plot")
f, ax, p = graphplot(graph; layout=Stress(; dim=3))
