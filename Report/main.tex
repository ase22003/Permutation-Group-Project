...
%
%\begin{proof}
	%%Let \(c\) be as defined above. Then \(\alpha_c\circ\beta_c(c)=\beta_c\circ\alpha_c(c)\Rightarrow\)
...
Since this group is the symmetric group \(S_6\), there must be a map
%\(\zeta_1:\{1,2,3\}\times\{4,5,6\} \to G\)
\(\zeta_1(x,y)=(x,y)\), where \(x\in\{1,2,3\}\) and \(y\in\{4,5,6\}\).
