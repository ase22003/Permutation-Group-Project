...
\begin{definition}[Group]
	...
	\begin{enumerate}
		...
		\item \textit{Existence of Inverse}: Each element in the group has its own \textit{inverse}, who's product therewith evalutes to the identity; \(\forall a\in G\ \exists b\in G\ (a*b=b*a=e)\), where \(e\) is the identity.
	\end{enumerate}
\end{definition}
